...
<header className="bg-slate-900 text-white py-8 px-4 sm:py-10 sm:px-6 shadow">
	<div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-start sm:items-center gap-4">
		...
		<div className="w-full">
			...
			<p className="text-slate-300 mt-1 text-center sm:text-left">
...
<footer className="bg-slate-100 text-slate-600 text-sm py-4 px-4 sm:px-6">
